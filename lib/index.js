...
var createMentionPlugin = function createMentionPlugin() {
  ...
  var _config$supportWhites = config.supportWhitespace;
  var supportWhitespace = _config$supportWhites === undefined ? false : _config$supportWhites;
  var _config$maxSuggestion = config.maxSuggestionsCharacters;
  var maxSuggestionsCharacters = _config$maxSuggestion === undefined ? 20 : _config$maxSuggestion;
  ...
  return {
    ...
    decorators: [{
      ...
      strategy: (0, _mentionSuggestionsStrategy2.default)(mentionTrigger, supportWhitespace, maxSuggestionsCharacters),
