...
exports.default = function (trigger, supportWhiteSpace, maxSuggestionsCharacters) {
  var MENTION_REGEX = supportWhiteSpace ? new RegExp((0, _escapeRegExp2.default)(trigger) + '[\\w\\s]{0,' + maxSuggestionsCharacters + '}', 'g') : new RegExp('(\\s|^)' + (0, _escapeRegExp2.default)(trigger) + '[\\w]*', 'g');
